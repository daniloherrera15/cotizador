...
$nven= str_replace(" ", "", $nven);
$cfilas=$_POST['cont'];
$prospecto=$_POST['prope'];
if ($prospecto == 1){
$con1 = new Connection($server,$user,$password,$dbname);
$con1->conectar();
$crud1 = new Crud();
$nom="Prospecto";
$ape="Prospecto";
...
$ciu=$_POST['ciu'];
$dir="Prospecto";
$array1[0] = "'$ape','$nom','$rso','$ide','$dir','$tel','$cel','$ciu','$ema','TRUE'";
$campos1="apellidos,nombres,razon_social,nit_cedula,direccion,telefono,celular,ciudad,email,prospecto";
$tabla1="c_cliente";
$crud1->insertar($array1,$campos1,$tabla1,$con1->getConnection(),'Prospecto Registrado - ');
$con1->desconectar();
}
$con = new Connection($server,$user,$password,$dbname);
$con->conectar();
$crud = new Crud();
$array[0] = "'$nit','$nven','$pcd','$fecha','11'";
$campos="id_tercero,id_vendedor,concepto_detalle,fecha_cotizacion,estado";
$tabla="cotizacion_maestro";
$crud->insertar($array,$campos,$tabla,$con->getConnection(),'');
$crud->setConsulta(
"select * from cotizacion_maestro where id_vendedor='$nven' and fecha_cotizacion='$fecha'");
...
//VERIFICA QUE LA INSERCIÓN FUE EXITOSA
        ...
        while ($a<=$cfilas) 
        {
          //INSERTA EL DETALLE
            ...
            $crud->insertar($array,$campos,$tabla,$con->getConnection(),'Cotización Ingresada Exitosamente.');
            $a++;
        }
